;(window.webpackJsonp = window.webpackJsonp || []).push([
	[6],
	{
		838: function (module, __webpack_exports__, __webpack_require__) {
			...
			var _ColorPicker,
				_fallbackColor,
				_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(2),
				...
				_storybook_theming__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(1)
			...
			var s = function s(e, r, t) {
				...
				m = react__WEBPACK_IMPORTED_MODULE_27___default.a.memo(function (o) {
					var a = o.onMove,
						...
						x = Object(react__WEBPACK_IMPORTED_MODULE_27__.useMemo)(
							function () {
								var e = function e(_e) {
										h(_e),
						...
						H = x[2]
					return (
						Object(react__WEBPACK_IMPORTED_MODULE_27__.useEffect)(
							function () {
								return H
							},
							[H],
				...
				b = function b(e, r, t) {
					return (
						void 0 === r && (r = 0), void 0 === t && (t = Math.pow(10, r)), Math.round(t * e) / t
					)
				},
			...
			function T(e, t, l) {
				var u = i(l),
					...
					s = c[0],
					f = c[1],
					v = Object(react__WEBPACK_IMPORTED_MODULE_27__.useRef)({ color: t, hsva: s })
				Object(react__WEBPACK_IMPORTED_MODULE_27__.useEffect)(
					function () {
			...
			for (
				var P =
						'undefined' != typeof window
							? react__WEBPACK_IMPORTED_MODULE_27__.useLayoutEffect
							: react__WEBPACK_IMPORTED_MODULE_27__.useEffect,
					R = new Map(),
					V = function V(e) {
						P(function () {
			...
			;(convert$1.rgb.hsl = function (rgb) {
				...
				(convert$1.hsl.rgb = function (hsl) {
					...
					for (
						var t1 = 2 * l - (t2 = l < 0.5 ? l * (1 + s) : l + s - l * s), rgb = [0, 0, 0], _i4 = 0;
						_i4 < 3;
						_i4++
					)
						(t3 = h + (1 / 3) * -(_i4 - 1)) < 0 && t3++,
				...
				(convert$1.hsv.hsl = function (hsv) {
					...
					return (
						(sl = s * vmin),
						[h, 100 * (sl = (sl /= lmin <= 1 ? lmin : 2 - lmin) || 0), 100 * (l /= 2)]
					)
				}),
			...
			function deriveBFS(fromModel) {
				var graph = (function buildGraph() {
						for (
							var graph = {}, models = Object.keys(conversions$1), len = models.length, _i5 = 0;
							_i5 < len;
							_i5++
						)
			...
			var colorConvert = convert,
				root = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__.ab,
			...
			var baseTrim = function baseTrim$1(string) {
				...
				isObject$2 = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__.db,
				isSymbol = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__.eb,
			...
			var toNumber_1 = function toNumber$1(value) {
				...
				isObject$1 = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__.db,
				now = now_1,
				toNumber = toNumber_1,
				nativeMax = Math.max,
				nativeMin = Math.min
			var debounce_1 = function debounce$1(func, wait, options) {
				...
				debounce = debounce_1,
				isObject = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__.db
			var ColorSpace,
				...
				Wrapper = _storybook_theming__WEBPACK_IMPORTED_MODULE_28__.l.div({
					position: 'relative',
					maxWidth: 250,
				}),
				PickerTooltip = Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_28__.l)(
					_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__.f,
				)({ position: 'absolute', zIndex: 1, top: 4, left: 4 }),
				TooltipContent = _storybook_theming__WEBPACK_IMPORTED_MODULE_28__.l.div({
					width: 200,
					margin: 5,
				...
				Note = Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_28__.l)(
					_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__.e,
				)(function (_ref) {
					return { fontFamily: _ref.theme.typography.fonts.base }
				}),
				Swatches = _storybook_theming__WEBPACK_IMPORTED_MODULE_28__.l.div({
					display: 'grid',
				...
				SwatchColor = _storybook_theming__WEBPACK_IMPORTED_MODULE_28__.l.div(function (_ref2) {
				...
				Swatch = function Swatch(_a) {
					var value = _a.value,
						...
						onClick = _a.onClick,
						style = _a.style,
						props = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__.J)(_a, [
							'value',
							'active',
							'onClick',
							'style',
				...
				Input = Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_28__.l)(
					_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__.b.Input,
				)(function (_ref3) {
					return {
						width: '100%',
						paddingLeft: 30,
				...
				ToggleIcon = Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_28__.l)(
					_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__.c,
				)(function (_ref4) {
					return {
						position: 'absolute',
						zIndex: 1,
			...
			var COLOR_SPACES = Object.values(ColorSpace),
						...
						if (HSL_REGEXP.test(value)) {
							...
							return (
								...
								_defineProperty(
									_ref10,
									ColorSpace.HEX,
									'#'.concat(colorConvert.hsl.hex([_h2, _s3, _l]).toLowerCase()),
								),
								_ref10
							)
						}
				...
				useColorInput = function useColorInput(initialValue, onChange) {
					var _useState2 = _slicedToArray(
							Object(react__WEBPACK_IMPORTED_MODULE_27__.useState)(initialValue || ''),
							2,
						),
						value = _useState2[0],
						setValue = _useState2[1],
						_useState4 = _slicedToArray(
							Object(react__WEBPACK_IMPORTED_MODULE_27__.useState)(function () {
						...
						_useState6 = _slicedToArray(
							Object(react__WEBPACK_IMPORTED_MODULE_27__.useState)(
					...
					var realValue = Object(react__WEBPACK_IMPORTED_MODULE_27__.useMemo)(
							function () {
						...
						updateValue = Object(react__WEBPACK_IMPORTED_MODULE_27__.useCallback)(
							function (update) {
						...
						cycleColorSpace = Object(react__WEBPACK_IMPORTED_MODULE_27__.useCallback)(
							function () {
				...
				ColorControl = function ColorControl(_ref12) {
					var name = _ref12.name,
						...
						_usePresets = (function usePresets(presetColors, currentColor, colorSpace) {
							...
							var presets = Object(react__WEBPACK_IMPORTED_MODULE_27__.useMemo)(
									function () {
										return (presetColors || [])
											.map(function (preset) {
												return 'string' == typeof preset
													? parseValue(preset)
													: preset.title
													  ? Object.assign(Object.assign({}, parseValue(preset.color)), {
								...
								addPreset = Object(react__WEBPACK_IMPORTED_MODULE_27__.useCallback)(
									function (color) {
					...
					return react__WEBPACK_IMPORTED_MODULE_27___default.a.createElement(
						...
						react__WEBPACK_IMPORTED_MODULE_27___default.a.createElement(
							PickerTooltip,
							{
								...
								tooltip: react__WEBPACK_IMPORTED_MODULE_27___default.a.createElement(
									TooltipContent,
									null,
									react__WEBPACK_IMPORTED_MODULE_27___default.a.createElement(
										Picker,
										Object.assign(
											...
											{ onChange: updateValue, onFocus: onFocus, onBlur: onBlur },
										),
									),
									presets.length > 0 &&
										react__WEBPACK_IMPORTED_MODULE_27___default.a.createElement(
						...
						react__WEBPACK_IMPORTED_MODULE_27___default.a.createElement(Input, {
							id: Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_26__.fb)(name),
							value: value,
						...
						value
							? react__WEBPACK_IMPORTED_MODULE_27___default.a.createElement(ToggleIcon, {
									icon: 'markup',
