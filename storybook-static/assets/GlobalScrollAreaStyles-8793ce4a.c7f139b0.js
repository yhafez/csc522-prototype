...
import { a7 as l, a8 as n } from './Props.13743566.js'
...
t(a, '_taggedTemplateLiteral')
var b = l(e || (e = a(['0%{z-index:0}to{z-index:-1}']))),
	c = t(function (o) {
		return {
			...
			'#os-dummy-scrollbar-size>div': { width: '200%', height: '200%', margin: 10 },
			...
			'.os-content>.os-textarea[wrap=off]': { whiteSpace: 'pre!important', margin: '0!important' },
			'.os-text-inherit': {
				fontFamily: 'inherit',
				fontSize: 'inherit',
				fontWeight: 'inherit',
			...
			'.os-resize-observer': { animationDuration: '.001s', animationName: ''.concat(b) },
			'.os-host-transition>.os-scrollbar, .os-host-transition>.os-scrollbar-corner': {
				transition: 'opacity .3s,visibility .3s,top .3s,right .3s,bottom .3s,left .3s',
			},
			'html.os-html>.os-host>.os-scrollbar': { position: 'absolute', zIndex: 999999 },
			'.os-scrollbar, .os-scrollbar-corner': { position: 'absolute', opacity: 1, zIndex: 1 },
			'.os-scrollbar-corner': {
				bottom: 0,
				right: 0,
				height: 10,
			...
			'.os-scrollbar-handle-off, .os-scrollbar-track-off': { pointerEvents: 'none' },
			...
			'.os-host-rtl>.os-scrollbar-corner.os-scrollbar-corner-resize': { transform: 'scale(-1,1)' },
			'.os-host-overflow': { overflow: 'hidden!important' },
			'.os-theme-dark.os-host-rtl>.os-scrollbar-horizontal': { left: 10, right: 0 },
			'.os-scrollbar.os-scrollbar-unusable': { background: 0 },
			'.os-scrollbar>.os-scrollbar-track': { background: 0 },
			'.os-scrollbar-horizontal>.os-scrollbar-track>.os-scrollbar-handle': { minWidth: 30 },
			'.os-scrollbar-vertical>.os-scrollbar-track>.os-scrollbar-handle': { minHeight: 30 },
			...
			'.os-scrollbar>.os-scrollbar-track>.os-scrollbar-handle': {
				background: o.color.mediumdark,
				opacity: 0.5,
			},
			'.os-scrollbar:hover>.os-scrollbar-track>.os-scrollbar-handle': { opacity: 0.6 },
			...
			'.os-theme-dark.os-host-scrollbar-horizontal-hidden>.os-scrollbar-horizontal .os-scrollbar-handle:before, .os-theme-dark.os-host-scrollbar-vertical-hidden>.os-scrollbar-vertical .os-scrollbar-handle:before':
				{ display: 'none' },
			'.os-scrollbar-horizontal .os-scrollbar-handle:before': { top: -6, bottom: -2 },
			'.os-scrollbar-vertical .os-scrollbar-handle:before': { left: -6, right: -2 },
			'.os-host-rtl.os-scrollbar-vertical .os-scrollbar-handle:before': { right: -6, left: -2 },
		}
	}, 'getScrollAreaStyles'),
	z = t(function () {
		return s(n, { styles: c })
	}, 'GlobalScrollAreaStyles')
export { z as default, c as getScrollAreaStyles }
//# sourceMappingURL=GlobalScrollAreaStyles-8793ce4a.c7f139b0.js.map
