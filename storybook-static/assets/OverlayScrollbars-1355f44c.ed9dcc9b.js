...
import { U as Mo, Y as Ro } from './Props.13743566.js'
import './es.number.to-fixed.54b1ee4f.js'
import { r as ln, b as Wo, j as wa } from './jsx-runtime.adda36d4.js'
				...
				return (
					e(f, 'firstLetterToUpper'),
					{
						...
						_cssProperty: e(function (p) {
							...
							for (
								var or = f(p), k = Hr.createElement('div')[s.s], R, ur = 0, W, Sr;
								ur < g.length;
								ur++
							)
								for (
									Sr = g[ur].replace(/-/g, ''), R = [p, g[ur] + p, Sr + or, f(Sr) + or], W = 0;
									W < R[s.l];
									W++
								)
									if (k[R[W]] !== M) {
						...
						_cssPropertyValue: e(function (p, F, or) {
							var k = p + ' ' + F,
								R = w[k]
							if (w[s.hOP](k)) return R
							for (
								var ur = Hr.createElement('div')[s.s],
									W = F.split(' '),
									Sr = or || '',
									I = 0,
									J = -1,
								...
								for (; J < Se._cssPrefixes[s.l]; J++)
									if (
										((G = J < 0 ? W[I] : Se._cssPrefixes[J] + W[I]),
										(ur.cssText = p + ':' + G + Sr),
										ur[s.l])
									) {
										R = G
						...
						_jsAPI: e(function (p, F, or) {
							var k = 0,
								R = O[p]
							if (!O[s.hOP](p)) {
								for (R = er[p]; k < a[s.l]; k++) R = R || er[(F ? a[k] : a[k].toLowerCase()) + f(p)]
								O[p] = R
							}
							return R || or
						}, '_jsAPI'),
					...
					easeInElastic: e(function (g, a, f, h, p) {
						...
						return a == 0
							...
							: (a /= p) == 1
							  ? f + h
							  : (or || (or = p * 0.3),
							    k < O.a(h) ? ((k = h), (F = or / 4)) : (F = (or / (2 * O.p)) * O.n(h / k)),
							    -(k * O.w(2, 10 * (a -= 1)) * O.s(((a * p - F) * (2 * O.p)) / or)) + f)
					}, 'easeInElastic'),
					easeOutElastic: e(function (g, a, f, h, p) {
						...
						return a == 0
							...
							: (a /= p) == 1
							  ...
							  : (or || (or = p * 0.3),
							    k < O.a(h) ? ((k = h), (F = or / 4)) : (F = (or / (2 * O.p)) * O.n(h / k)),
							    k * O.w(2, -10 * a) * O.s(((a * p - F) * (2 * O.p)) / or) + h + f)
					}, 'easeOutElastic'),
						...
						return a == 0
							...
							: (a /= p / 2) == 2
							  ...
							  : (or || (or = p * (0.3 * 1.5)),
							    k < O.a(h) ? ((k = h), (F = or / 4)) : (F = (or / (2 * O.p)) * O.n(h / k)),
							    a < 1
										? -0.5 * (k * O.w(2, 10 * (a -= 1)) * O.s(((a * p - F) * (2 * O.p)) / or)) + f
										: k * O.w(2, -10 * (a -= 1)) * O.s(((a * p - F) * (2 * O.p)) / or) * 0.5 +
										  h +
										  f)
					}, 'easeInOutElastic'),
			...
			q = (function () {
				...
				function H(u, i, o) {
					if (T.isA(o)) for (var l = 0; l < o[s.l]; l++) H(u, i, o[l])
						...
						p(o) == b.s
							? u.insertAdjacentHTML(i, o)
							: u.insertAdjacentElement(i, o.nodeType ? o : o[0])
				}
				...
				function $(u, i) {
					...
					i !== !1 && u.q.splice(0, 1),
						u.q[s.l] > 0
							? ((l = u.q[0]), E(u.el, l.props, l.duration, l.easing, l.complete, !0))
							: ((o = k(u, h)), o > -1 && h.splice(o, 1))
				}
							...
							if (zr > 0)
								(Cr = T.now()),
									(fa = e(function () {
										...
										R(Dr) && Dr({}, Me, N.max(0, zr - Je)),
											Fe ? ($(Ir), R(_) && _()) : (pr.frame = T.rAF()(fa))
									}, 'frame')),
									(pr.frame = T.rAF()(fa))
							else {
				...
				function rr(u) {
					...
					if (o) {
						for (
							p(o) != b.s && (!I(o) || o === er || o === o.self) && (o = [o]), l = 0;
							l < o[s.l];
							l++
						)
							i[l] = o[l]
				...
				return (
					...
					(rr[s.p] = {
						...
						removeClass: e(function (i) {
							...
							if (i) {
								for (o = i.match(O) || []; (l = this[ar++]); )
									if (((P = l.classList), K === M && (K = P !== M), K))
										for (; (L = o[Ir++]); ) P.remove(L)
									else if (((m = l.className + g), (_ = l.nodeType === 1 && w + J(m) + w), _)) {
										for (; (L = o[Ir++]); )
											for (; _.indexOf(w + L + w) > -1; ) _ = _.replace(w + L + w, w)
										;(z = J(_)), m !== z && (l.className = z)
									}
							}
							return this
							...
							return (
								this.each(function () {
									for (_ = this.children, m = 0; m < _[s.l]; m++)
										(l = _[m]),
											i ? ((l.matches && l.matches(i)) || G(l, i)) && o.push(l) : o.push(l)
								}),
								rr(o)
							)
						}, 'children'),
					...
					or(rr, { extend: or, inArray: k, isEmptyObject: ur, isPlainObject: W, each: Sr }),
					rr
				)
			})(),
			Wa = (function () {
								...
								var l = e(function _(m) {
									...
									for (L in m)
										!m[s.hOP](L) ||
											((z = m[L]),
											(K = k(z)),
											K == b.a ? (m[L] = z[o ? 1 : 0]) : K == b.o && (m[L] = _(z)))
									return m
								}, 'recursive')
										...
										for (var xr in qr)
											if (qr[s.hOP](xr) && Tr[s.hOP](xr)) {
												...
												if (((pr = pr === M ? {} : pr), Je && ft == b.o))
													...
													for (X = 0; X < ha[s.l]; X++)
														if (
															((da = ha[X]), (fa = k(da)), (br = fa == b.s && P(da, R) === -1), br)
														)
															for (
																Xe.push(b.s), ue = da.split(ur), Kr = Kr.concat(ue), gr = 0;
																gr < ue[s.l];
																gr++
															) {
				...
				function p(k) {
					...
					var fr = Jr(G),
						...
						$ = (function () {
							...
							return (
								rr > 0
									? (l = _(E[yr](rr + 5, E[dr]('.', rr)), 10))
									: u > 0
									  ? (l = _(E[yr](o + 3, E[dr]('.', o)), 10))
									  : i > 0 && (l = _(E[yr](i + 5, E[dr]('.', i)), 10)),
								l
							)
						})()
					q.extend(R, {
						...
						nativeScrollbarStyling: (function () {
							...
							try {
								E =
									...
									er.getComputedStyle(G, '::-webkit-scrollbar').getPropertyValue('display') ===
										'none'
							} catch {}
							return E
						})(),
						...
						rtlScrollBehavior: (function () {
							...
							J.scrollLeft(-999)
							var yr = H.offset()
							return { i: E.left === dr.left, n: dr.left !== yr.left }
						})(),
					...
					function Jr(E) {
						return { x: E[s.oH] - E[s.cH], y: E[s.oW] - E[s.cW] }
					}
				...
				function F(k) {
									...
									for (var z = 0; z < G[J]; z++)
										(o = G[z]),
											o !== M &&
												...
												(_ === !0 || _ === null) &&
													L - H[z] > m &&
													(o.update('auto'), (H[z] = new Date((L += m)))),
												(i = N.max(1, N.min(i, m))))
									$ = i
								}
							} else $ = ze
					...
					;(R.add = function (yr) {
						ur(yr, G) === -1 &&
							(G.push(yr),
							H.push(W()),
							G[J] > 0 && !fr && ((fr = !0), (k.autoUpdateLoop = fr), dr()))
					}),
						(R.remove = function (yr) {
							...
							rr > -1 &&
								...
								G[J] === 0 &&
									fr &&
									((fr = !1), (k.autoUpdateLoop = fr), E !== M && (T.cAF()(E), (E = -1))))
						})
				}
				...
				function or(k, R, ur, W, Sr) {
								...
								if (r[0] === Cn) {
									var ta = e(function () {
										...
										return (
											S !== vs &&
												(S === 'ltr'
													? ((Or[br] = 0), (Or[ue] = Mr), (Er = d))
													: ((Or[br] = Mr), (Or[ue] = 0), (Er = E.n ? -d : E.i ? 0 : d)),
					...
					function vo(r) {
						...
						if (c === 'attributes' && (t === s.c || t === s.s) && !P) {
							...
							if (n[v](Qe + ht) !== null || n[v](Qe + Fa) !== null || n[v](Qe + Xn) !== null)
								return !1
						}
						return !0
					}
					...
					function ma(r) {
						...
						if (
							...
							if (
								...
								(Sa = Sa || { x: !1, y: !1 }),
								Ne &&
									(_e(j, si + he + bn), Xr(j, Yr !== M && Yr !== null && Yr.length > 0 ? Yr : bn)),
							...
							v && (_a.find('*').trigger(Ue), qr && pa.find('*').trigger(Ue)),
								(C = C === M ? j.is(':hidden') : C)
							...
							var ee = hr ? br : ue,
								...
								Xa =
									qr && j.css(ge) !== 'none'
										? N.round(na.right - na.left) === 0 && ($r ? !0 : Ve[s.cW] - zr > 0)
										: !1
							if (Wr && !Xa) {
								var Za = Ve[s.oW],
									wt = Ae.css(X)
							...
							if (
								...
								Ct(B, ve, [-Br.t, -Br.r, -Br.b, -Br.l]),
									$r ? (Ct(ae, Y, ot), Ct(P ? Ee : U, Re)) : (Ct(ae, Y), Ct(P ? Ee : U, Re, ot)),
									Ze.css(ae),
									cr.css(Ee)
							}
							pr = ke()
							...
							if (
								...
								jr
									? ((B[X] = Mr),
									  (U[X] = Se._cssPropertyValue(X, 'max-content intrinsic') || Mr),
									  (U[ge] = sr))
									: (B[X] = Y),
								...
								if (((Dt.c = x(Dt, hs)), (hs = Dt), Wr)) {
									;(Dt.c || Fr || jr) &&
										((B[X] = Dt.w), (B[gr] = Dt.h), P || (nn = { w: lt[s.cW], h: lt[s.cH] }))
									var Us = {},
										Qs = e(function (Gr) {
											var ye = ea(Gr),
												ua = ye._w_h,
												...
												Et = Gr ? zr : Te,
												Dn = Gr ? xr : me,
												zn = pr[ua] - Oa - Dn - (Tr ? 0 : Et)
											;(!vr || (!vr && ca.c)) && (B[Vr] = Hi[ua] - 1),
												vr &&
													nn[ua] < zn &&
													(Gr && P ? !Ye : !0) &&
													(P && (Us[Vr] = Ha(Va.css(Vr)) - 1), (B[Vr] -= 1)),
								...
								if (
									...
									(Lr.x && wr.x) || (Lr.y && wr.y) || Ii
										? P && Ii && (ae[ga] = ae[Ca] = ct)
										: (!Pe || on.x || zt.x || on.y || zt.y) &&
										  (P && (ae[ga] = ae[Ca] = Y), (le[ga] = le[Ca] = va)),
									Ze.css(ae),
									nr.css(le),
									(le = {}),
									(Lr.c || Ge || mr || ie) && !($.x && $.y))
									...
									if (za) {
										var js = oi === M ? !0 : za._rows !== oi._rows,
											...
											In = {
												...
												y: (Ye ? Js || (js && (Tn ? A.y === Tn.y : !1)) : (Js || js) && Gs === So)
													? It.y
													: -1,
											}
										;(A.x = In.x > -1 ? (hr && qa && E.i ? 0 : In.x) : A.x),
											(A.y = In.y > -1 ? In.y : A.y)
									}
									oi = za
								}
								hr && E.i && $.y && Lr.x && qa && (A.x += fa.w || 0),
									jr && j[de](0),
									Fr && j[pe](0),
									nr[de](A.x)[pe](A.y)
								var Io = tr === 'v',
							...
							r
								? (Dr && z
										? (_a.children().remove(),
										  ...
										  Xr(j, P ? Kn : Ce))
										: (Ya(_a),
										  Rr.contents().unwrap().unwrap().unwrap(),
										  P && (cr.unwrap(), Ya(j), Ya(Va), C())),
								  P && cr.removeAttr(s.s),
								  ar && _e(Tt, Ri))
								: (P &&
					...
					function po() {
						...
						function D(Q) {
							var lr = Q.keyCode
							J(lr, r) < 0 &&
								(t[s.l] || (y(), (n = setInterval(y, 1e3 / 60))), J(lr, t) < 0 && t.push(lr))
						}
						...
						function _r(Q) {
							Cr ||
								(c !== M
									? clearTimeout(c)
									: ((it || ra) && La(!0), en() || Xr(j, fn), qe('onScrollStart', Q)),
								st || (xa(!0), xa(!1)),
								qe('onScroll', Q),
					...
					function wi(r) {
						var t = e(function (y) {
							var C = y ? no : io,
								...
								V = Ka(Gi, x)
							return (
								!Dr && !r && (x.append(A), A.append(V)), { _scrollbar: x, _track: A, _handle: V }
							)
					...
					function Ps(r) {
						...
						function Zr(S) {
							var Or = S.originalEvent || S,
								Er = Or.touches !== M
							return Cr || K || en() || !ii || (Er && !Z('touchSupport'))
								? !1
								: T.mBtn(S) === 1 || Er
						}
						...
						function ne(S) {
							if (
								((S = S || S.originalEvent),
								Be(Ea, [Ft, Bt, Un, Qn, Ut], [$r, ne, Ne, oe, rn], !0),
								T.rAF()(function () {
									Be(Ea, A, Yr, !0, { _capture: !0 })
								}),
								st && xa(r, !0),
								(st = !1),
								_e(_t, dt),
						...
						function re(S) {
							;(ir = nr[y]()),
								...
								Xr(t._handle, C),
								Xr(t._scrollbar, C),
								Be(Ea, [Ft, Bt, Ut], [$r, ne, rn]),
								T.rAF()(function () {
									Be(Ea, A, Yr, !1, { _capture: !0 })
								}),
								(yr || !Ir) && T.prvD(S),
								T.stpP(S)
						}
						...
						function Wr(S) {
							if (Zr(S)) {
								var Or =
										...
										Math.round(N.min(1, pr[t._w_h] / xt[t._w_h]) * t._info._trackLength),
									Er = N.round(pr[t._w_h] * Or),
									Oe = 270 * Or,
									ja = 400 * Or,
					...
					function La(r, t) {
						if ((clearTimeout(ks), r)) _e(bt, Vt), _e(yt, Vt)
						else {
							var n,
								c = 'active',
								v = e(function () {
					...
					function xa(r, t) {
						var n = I(t) == b.b,
							...
							Z,
							kr =
								(mt[Ue + d._Width_Height] - mt['client' + d._Width_Height]) * (E.n && v ? -1 : 1),
							se = e(function (Pe) {
						...
						;(y._maxScroll = kr),
							...
							l
								? ((lr = v ? -(ir - tr - Zr) : Zr),
								  ...
								  o &&
										(Q[A] =
											n && N.abs(Zr - y._handleOffset) > 1
												? bo(d._handle) + ', ' + (x + he + c + 'ms')
												: Y))
								: (Q[d._left_top] = Zr),
							en() ||
								(d._handle.css(Q),
					...
					function Ei(r) {
						;(He = He || Ka(Xn, !0)),
							r ? (Dr && z ? _e(He.removeAttr(s.s), Zn) : Ya(He)) : Dr || j.append(He)
					}
					...
					function _o() {
						...
						function d(A) {
							if (C(A)) {
								var V = x(A),
									D = {}
								;(_i || En) && (D[X] = n.w + (V.x - t.x) * c.x),
									(bi || En) && (D[gr] = n.h + (V.y - t.y) * c.y),
									j.css(D),
									T.stpP(A)
							} else y(A)
						}
					...
					function Ms(r, t) {
						var n,
							...
							d = e(function (C, x) {
								if (((v = ''), x && Ra(C) == b.s))
									for (c = C.split(he), n = 0; n < c[s.l]; n++) v += '|' + c[n] + '$'
								return v
							}, 'appendClasses')
...
`),
					...
					function Ka(r, t) {
						...
						return Dr && !c[s.l]
							? null
							: Dr
							  ? c[n ? 'children' : 'find'](Qe + r.replace(/\s/g, Qe)).eq(0)
							  : q(Ke(r))
					}
					...
					e(Nt, 'findFirst'),
						...
						(H.scroll = function (r, t, n, c) {
							...
							function Br(U, B) {
								...
								if (
									(Ur
										? (B[Ar] > 2 && ((Ca = B.substr(0, 2)), J(Ca, _r) > -1 && (ke = Ca)),
										  (B = ke ? B.substr(2) : B),
										  (B = B[be](/min/g, 0)
												[be](/</g, 0)
												[be](/max/g, (la ? '-' : Y) + Ba)
									...
									;(Pr = Aa ? Ee - Pr : Pr),
										(Pr *= tn ? -1 : 1),
										(Pr = $a && E.n ? N.min(0, N.max(Ee, Pr)) : N.max(0, N.min(Ee, Pr)))
								}
								return Pr === ae ? M : Pr
							}
							e(Br, 'getFinalScroll')
							...
							function ee(U) {
								...
								for (Z = 0; Z < U[Ar] && Z !== Qr[Ar]; Z++)
									(Ur = U[Z]),
										(ke = I(Ur)),
										ke == b.b ? B.push(Ur ? Ha(Oe.css(ve + Qr[Z])) : 0) : B.push(ke == b.n ? Ur : 0)
								return B
							}
							if ((e(ee, 'generateMargin'), Ye || an)) {
								...
								if (((Oe = Ye ? Na : q(Na)), Oe[Ar] > 0)) {
									...
									if (
										(hr &&
											(!E.n && !E.i && (oa.x = N.round(sa[br] - Fr[br] + mr.l)),
											E.n && D && (oa.x *= -1),
											E.i && D && (oa.x = N.round(sa[br] - Fr[br] + (Je._maxScroll - mr.l)))),
										Or.x != $r || Or.y != $r || S.x == ta || S.y == ta || hr)
									) {
										var Pt = Oe[0],
											kt = l ? Pt[s.bCR]() : { width: Pt[s.oW], height: Pt[s.oH] },
											ca = { w: kt[X] + Er[3] + Er[1], h: kt[gr] + Er[0] + Er[2] },
											Pa = e(function (B) {
												var Ur = ea(B),
													ke = Ur._w_h,
													Qr = Ur._left_top,
												...
												Pr
													...
													: ie[ce] ||
													  ((ot || $a) &&
															((ie[ce] = $a ? tn : !1), (ae = ga < la ? va > Aa : va < Aa)),
													  (oa[ce] -=
															ae || Ee ? (la / ct - ga / ct) * (B && hr && D ? -1 : 1) : 0))
											}, 'finalizeBlock')
										Pa(!0), Pa(!1)
									}
						...
						(H.addExt = function (r, t) {
							...
							if (n) {
								...
								if (
									...
									c &&
										((d = c.contract), I(d) == b.f && ((y = d(er)), (C = I(y) == b.b ? y : C)), C))
								)
					...
					function go(r, t, n) {
						;(es = W.defaultOptions),
							...
							(Ir = Lt !== Hr),
							(Dr = P
								? cr.hasClass(hn) && cr.parent().hasClass(Jn)
								: cr.hasClass(Ce) && cr.children(Qe + jn)[s.l])
						var c, v
						return $.x && $.y && !te.nativeScrollbarsOverlaid.initialize
							...
							: (ar &&
							  ...
							  ar &&
									...
									Hr.activeElement == r &&
										mt.focus &&
										(nr.attr(s.ti, '-1'), mt.focus(), Be(nr, St, v, !1, !0))),
							  H.update(Mr),
							  (z = !0),
							  qe('onInitialized'),
							  G($n, function (d, y) {
				...
				return (
					...
					(O.extension = function (k, R, ur) {
						...
						if (W) {
							if (T.type(R) == b.f) a.push({ name: k, extensionFactory: R, defaultOptions: ur })
							else
								for (; I < a[s.l]; I++)
									if (a[I].name === k)
...
function Xs(ka, er) {
	if (vn.valid(ka)) {
		var Hr = ka.getElements(),
			M = Hr.host,
			Mt = new RegExp(
				'(^os-host([-_].+|)$)|'.concat(ka.options().className.replace(/\s/g, '$|'), '$'),
				'g',
			),
			b = M.className
				.split(' ')
...
export { Yo as OverlayScrollbarsComponent, Yo as default }
//# sourceMappingURL=OverlayScrollbars-1355f44c.ed9dcc9b.js.map
