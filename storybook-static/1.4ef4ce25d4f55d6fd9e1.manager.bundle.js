;(window.webpackJsonp = window.webpackJsonp || []).push([
	[1],
	{
		459: function (module, __webpack_exports__, __webpack_require__) {
			...
			var _templateObject,
				_templateObject2,
				_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(2),
				...
				_storybook_theming__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(1),
				react_dom__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(127),
			...
			var arrow$1 = {
				...
				fn: function arrow(_ref) {
					var _state$modifiersData$,
						...
						len =
							[
								_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.R,
								_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.X,
									...
									'number' !=
										typeof (padding =
											'function' == typeof padding
												...
												: padding)
										? padding
										: expandToHashMap(padding, _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.L),
								)
							})(options.padding, state),
							arrowRect = getLayoutRect(arrowElement),
							minProp =
								'y' === axis
									? _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.Z
									: _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.R,
							maxProp =
								'y' === axis
									? _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.N
									: _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.X,
							endDiff =
			...
			function mapToStyles(_ref2) {
				...
				var hasX = offsets.hasOwnProperty('x'),
					...
					sideY = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.Z,
					win = window
				if (adaptive) {
					...
					if (
						...
						placement === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.Z ||
							((placement === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.R ||
								placement === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.X) &&
								variation === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.O))
					)
						(sideY = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.N),
							(y -=
					...
					if (
						placement === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.R ||
						((placement === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.Z ||
							placement === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.N) &&
							variation === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.O)
					)
						(sideX = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.X),
							(x -=
								(isFixed && win.visualViewport
			...
			function getClientRectFromMixedType(element, clippingParent) {
				return clippingParent === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.bb
					? rectToClientRect(
			...
			function computeOffsets(_ref) {
				...
				switch (basePlacement) {
					case _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.Z:
						offsets = { x: commonX, y: reference.y - element.height }
						break
					case _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.N:
						offsets = { x: commonX, y: reference.y + reference.height }
						break
					case _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.X:
				...
				if (null != mainAxis) {
					...
					switch (variation) {
						case _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.Y:
							offsets[mainAxis] = offsets[mainAxis] - (reference[len] / 2 - element[len] / 2)
							break
						case _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.O:
							offsets[mainAxis] = offsets[mainAxis] + (reference[len] / 2 - element[len] / 2)
					}
				}
				return offsets
			...
			function detectOverflow(state, options) {
				...
				var _options = options,
					...
					boundary =
						void 0 === _options$boundary
							? _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.P
							: _options$boundary,
					_options$rootBoundary = _options.rootBoundary,
					rootBoundary =
						void 0 === _options$rootBoundary
							? _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.bb
							: _options$rootBoundary,
					_options$elementConte = _options.elementContext,
					elementContext =
						void 0 === _options$elementConte
							? _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.V
					...
					altContext =
						elementContext === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.V
							? _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.Q
							: _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.V,
				...
				if (elementContext === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.V && offsetData) {
			...
			var offset$1 = {
				...
				fn: function offset(_ref2) {
					var state = _ref2.state,
						...
						data = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.T.reduce(function (
							acc,
							placement,
						) {
							return (
					...
					if (popperOffsets) {
						if (checkMainAxis) {
							var _offsetModifierState$,
								...
								minLen =
									variation === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.Y
										? referenceRect[len]
										: popperRect[len],
								maxLen =
									variation === _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.Y
								...
								preventedOffset = within(
									tether
										? min(min$1, offset + minOffset - offsetModifierValue - clientOffset)
										: min$1,
									offset,
						...
						instance = {
							...
							setOptions: function setOptions(setOptionsAction) {
								...
								var orderedModifiers = (function orderModifiers(modifiers) {
									...
									return _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.W.reduce(function (
										acc,
										phase,
									) {
										return acc.concat(
							...
							if (!state.modifiersData[name]._skip) {
								for (
									var _options$mainAxis = options.mainAxis,
											...
											(basePlacement === preferredPlacement || !flipVariations
												...
												: (function getExpandedFallbackPlacements(placement) {
														if (
															...
															_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.U
														)
															return []
										...
										placements = [preferredPlacement].concat(fallbackPlacements).reduce(function (
											acc,
											placement,
										) {
											return acc.concat(
															...
															var _options = options,
																...
																allowedAutoPlacements =
																	void 0 === _options$allowedAutoP
																		? _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.T
																		: _options$allowedAutoP,
																variation = getVariation(placement),
																placements$1 = variation
																	? flipVariations
																		? _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.S
																		: _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.S.filter(
																				function (placement) {
																					return getVariation(placement) === variation
																				},
																		  )
																	: _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.L,
									...
									var placement = placements[i],
										...
										isStartVariation =
											...
											_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.Y,
										isVertical =
											[
												_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.Z,
												_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.N,
			...
			var ManagerReferenceNodeContext = react__WEBPACK_IMPORTED_MODULE_35__.createContext(),
				ManagerReferenceNodeSetterContext = react__WEBPACK_IMPORTED_MODULE_35__.createContext()
			function Manager(_ref) {
				...
				var handleSetReferenceNode = react__WEBPACK_IMPORTED_MODULE_35__.useCallback(function (
					node,
				) {
			...
			function Popper(_ref) {
				var _ref$placement = _ref.placement,
					...
					modifiers = void 0 === _ref$modifiers ? EMPTY_MODIFIERS : _ref$modifiers,
				...
				var options = react__WEBPACK_IMPORTED_MODULE_35__.useMemo(
					...
					_usePopper = (function usePopper(referenceElement, popperElement, options) {
						...
						var prevOptions = react__WEBPACK_IMPORTED_MODULE_35__.useRef(null),
							...
							updateStateModifier = react__WEBPACK_IMPORTED_MODULE_35__.useMemo(function () {
								return {
									name: 'updateState',
									enabled: !0,
									phase: 'write',
			...
			var TooltipContext = react__WEBPACK_IMPORTED_MODULE_35___default.a.createContext({}),
					...
					function Tooltip() {
						...
						return (
							...
							(_this.getArrowProps = function (props) {
								return (
									void 0 === props && (props = {}),
									Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.i)({}, props, {
										style: Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.i)(
											{},
											props.style,
							...
							(_this.getTooltipProps = function (props) {
								return (
									void 0 === props && (props = {}),
									Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.i)(
										{},
										props,
					...
					return (
						...
						(_this.showTooltip = function (_ref) {
							...
							_this.props.followCursor &&
								(state = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.i)({}, state, {
									pageX: pageX,
									pageY: pageY,
								})),
				...
				return (
					...
					(_proto.render = function render() {
						var _this2 = this,
							...
							restProps = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.h)(_this$props, [
								'children',
								'tooltip',
								'placement',
								'trigger',
							...
							popper = react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(
								Popper,
								Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.i)(
									{
						...
						return react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(
							...
							this.getState() &&
								(usePortal
									? Object(react_dom__WEBPACK_IMPORTED_MODULE_37__.createPortal)(
											popper,
											portalContainer,
									  )
									: popper),
			...
			var TooltipTrigger$1 = TooltipTrigger,
						...
						return {
							...
							borderTopColor: match(
								...
								theme.color[color] || color || 'light' === theme.base
									? Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_36__.k)(theme.background.app)
				...
				Wrapper = _storybook_theming__WEBPACK_IMPORTED_MODULE_36__.l.div(
					function (_ref8) {
						return { display: _ref8.hidden ? 'none' : 'inline-block', zIndex: 2147483647 }
					},
					function (_ref9) {
				...
				Tooltip = function Tooltip(_a) {
					var placement = _a.placement,
						...
						color = _a.color,
						props = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.J)(_a, [
							'placement',
							'hasChrome',
							'children',
							'arrowProps',
					...
					return react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(
						Wrapper,
						Object.assign({ hasChrome: hasChrome, placement: placement, ref: tooltipRef }, props, {
							color: color,
						}),
						hasChrome &&
							react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(
								Arrow,
								Object.assign({ placement: placement, ref: arrowRef }, arrowProps, {
									color: color,
								}),
							),
						children,
			...
			var document$1 = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.cb.document,
				TargetContainer = _storybook_theming__WEBPACK_IMPORTED_MODULE_36__.l.div(
					_templateObject ||
				...
				TargetSvgContainer = _storybook_theming__WEBPACK_IMPORTED_MODULE_36__.l.g(
			...
			var WithToolTipState = function WithToolTipState(_a) {
				var startOpen = _a.startOpen,
					...
					rest = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_34__.J)(_a, [
						'startOpen',
						'onVisibilityChange',
					]),
					_useState2 = _slicedToArray(
						Object(react__WEBPACK_IMPORTED_MODULE_35__.useState)(startOpen || !1),
						2,
					),
					tooltipShown = _useState2[0],
					setTooltipShown = _useState2[1],
					onVisibilityChange = Object(react__WEBPACK_IMPORTED_MODULE_35__.useCallback)(
						function (visibility) {
