/*! For license information please see 0.e7e45abba80706f964bf.manager.bundle.js.LICENSE.txt */
	...
	[0],
	{
		316: function (module, __webpack_exports__, __webpack_require__) {
			...
			__webpack_require__.r(__webpack_exports__),
				...
				__webpack_require__.d(__webpack_exports__, 'createCopyToClipboardFunction', function () {
			...
			var _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(2),
				react__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(0),
				react__WEBPACK_IMPORTED_MODULE_36___default = __webpack_require__.n(
					react__WEBPACK_IMPORTED_MODULE_36__,
				),
				_storybook_client_logger__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(10),
				_storybook_theming__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(1),
				memoizerific__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(25),
				memoizerific__WEBPACK_IMPORTED_MODULE_39___default = __webpack_require__.n(
					memoizerific__WEBPACK_IMPORTED_MODULE_39__,
				)
				...
				!(function (Prism) {
					...
					;(spread = re(spread).source),
						...
						Prism.languages.insertBefore(
							'inside',
							'attr-name',
							{ spread: { pattern: re(/<SPREAD>/.source), inside: Prism.languages.jsx } },
			...
			function getClassNameCombinations(classNames) {
				if (0 === classNames.length || 1 === classNames.length) return classNames
				var key = classNames.join('.')
				return (
					classNameCombinations[key] ||
						(classNameCombinations[key] = (function powerSetPermutations(arr) {
			...
			function createElement(_ref) {
				...
				if (TagName) {
					var props,
						childrenCreator = (function createChildren(stylesheet, useInlineStyles) {
							var childrenCount = 0
					...
					if (useInlineStyles) {
						var allStylesheetSelectors = Object.keys(stylesheet).reduce(function (
							...
							startingClassName =
								properties.className && properties.className.includes('token') ? ['token'] : [],
							className =
					...
					return react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(
						TagName,
						Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.i)({ key: key }, props),
						children,
					)
				}
			}
			...
			function createLineElement(_ref3) {
				...
				return (
					wrapLongLines & showLineNumbers &&
						(properties.style = _objectSpread({}, properties.style, { display: 'flex' })),
					{ type: 'element', tagName: 'span', properties: properties, children: children }
				)
			}
			...
			;(DefinedInfo$2.prototype = new Info$1()), (DefinedInfo$2.prototype.defined = !0)
			var checks = [
					'boolean',
					'booleanish',
					'overloadedBoolean',
			...
			function DefinedInfo$2(property, attribute, mask, space) {
				...
				for (
					...
					mark(this, (check = checks[index]), (mask & types$2[check]) === types$2[check])
			}
			...
			var caseSensitiveTransform_1 = function caseSensitiveTransform$1(attributes, attribute) {
				return attribute in attributes ? attributes[attribute] : attribute
			}
			var caseSensitiveTransform = caseSensitiveTransform_1,
				caseInsensitiveTransform_1 = function caseInsensitiveTransform$2(attributes, property) {
					...
					normal.length > 4 &&
						...
						('-' === value.charAt(4)
							...
							: (value = (function datasetToAttribute(property) {
									...
									'-' !== (value = value.replace(cap$1, kebab)).charAt(0) && (value = '-' + value)
									return 'data' + value
							  })(value)),
						(Type = DefinedInfo))
			...
			var find = find_1,
				...
				factory_1 = function factory$1(schema, defaultTagName, caseSensitive) {
			...
			function isChildren(value, node) {
				return (
					...
					(function isNode(tagName, value) {
						...
						if ('object' === _typeof(value.children) && 'length' in value.children) return !0
			...
			var characterEntities = {
				...
				decodeEntity_1 = function decodeEntity$1(characters) {
					return !!own$2.call(characterEntities, characters) && characterEntities[characters]
				},
			...
			!(function (module) {
				...
				module.exports && (module.exports = Prism),
					void 0 !== _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.I &&
						(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.I.Prism = Prism)
			})(prismCore)
			var clike_1 = clike$1
			...
			var ctx =
					'object' === ('undefined' == typeof globalThis ? 'undefined' : _typeof(globalThis))
						? globalThis
						: 'object' === ('undefined' == typeof self ? 'undefined' : _typeof(self))
						  ? self
						  : 'object' === ('undefined' == typeof window ? 'undefined' : _typeof(window))
						    ? window
						    : 'object' === _typeof(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.I)
						      ? _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.I
						      : {},
			...
			var SyntaxHighlighter$1 = (function highlight$1(defaultAstGenerator, defaultStyle) {
				return function SyntaxHighlighter(_ref7) {
					var language = _ref7.language,
						...
						wrapLongLines = void 0 !== _ref7$wrapLongLines && _ref7$wrapLongLines,
						...
						rest = (function _objectWithoutProperties(source, excluded) {
							...
							var key,
								i,
								target = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.h)(
									source,
									excluded,
								)
					...
					var allLineNumbers = showLineNumbers
							? react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(AllLineNumbers, {
					...
					;((void 0 === wrapLines && renderer) || wrapLongLines) && (wrapLines = !0),
					...
					var defaultCodeValue = [{ type: 'text', value: code }],
						codeTree = (function getCodeTree(_ref6) {
							...
							if (isHighlightJs(astGenerator)) {
								var hasLanguage = (function checkForListedLanguage(astGenerator, language) {
			...
			var ReactSyntaxHighlighter = SyntaxHighlighter$1,
				navigator = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.cb.navigator,
				document$1 = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.cb.document,
				globalWindow = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.cb.window
			...
			function createCopyToClipboardFunction() {
				...
				return (null == navigator ? void 0 : navigator.clipboard)
					...
					: function (text) {
							return Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.H)(
								_this,
								void 0,
								void 0,
			...
			var Wrapper = _storybook_theming__WEBPACK_IMPORTED_MODULE_38__.l.div(
					function (_ref10) {
						return {
							position: 'relative',
							overflow: 'hidden',
				...
				Scroller = Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_38__.l)(function (_ref12) {
					var children = _ref12.children,
						className = _ref12.className
					return react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(
						_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.d,
				...
				Pre = _storybook_theming__WEBPACK_IMPORTED_MODULE_38__.l.pre(function (_ref14) {
				...
				Code = _storybook_theming__WEBPACK_IMPORTED_MODULE_38__.l.div(function (_ref15) {
					return { flex: 1, paddingLeft: 2, paddingRight: _ref15.theme.layoutMargin, opacity: 1 }
				}),
				SyntaxHighlighter = function SyntaxHighlighter(_a) {
					var children = _a.children,
						...
						showLineNumbers = void 0 !== _a$showLineNumbers && _a$showLineNumbers,
						rest = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.J)(_a, [
							'children',
							'language',
							'copyable',
							'bordered',
					...
					var highlightableCode = formatter ? formatter(format, children) : children.trim(),
						_useState2 = _slicedToArray(
							Object(react__WEBPACK_IMPORTED_MODULE_36__.useState)(!1),
							2,
						),
						copied = _useState2[0],
						setCopied = _useState2[1],
						onClick = Object(react__WEBPACK_IMPORTED_MODULE_36__.useCallback)(function (e) {
							e.preventDefault()
							...
							copyToClipboard(textToCopy)
								...
								.catch(_storybook_client_logger__WEBPACK_IMPORTED_MODULE_37__.a.error)
						}, [])
					return react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(
						Wrapper,
						{ bordered: bordered, padded: padded, className: className, onCopyCapture: onClick },
						react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(
							Scroller,
							null,
							react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(
						...
						copyable
							? react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(
									_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.a,
									{ actionItems: [{ title: copied ? 'Copied' : 'Copy', onClick: onClick }] },
							  )
							: null,
					)
				}
		...
		842: function (module, exports, __webpack_require__) {
			var $ = __webpack_require__(5),
				uncurryThis = __webpack_require__(15),
				toAbsoluteIndex = __webpack_require__(145),
